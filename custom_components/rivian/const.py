...
SENSORS: Final[dict[str, dict[str, RivianSensorEntity]]] = {
    "R1": {
...
BINARY_SENSORS: Final[dict[str, dict[str, RivianBinarySensorEntity]]] = {
    "R1": {
...
VEHICLE_STATE_API_FIELDS = {
    *(key for sensor in SENSORS.values() for key in sensor),
    *(key for sensor in BINARY_SENSORS.values() for key in sensor),
    "gnssLocation",
    "otaCurrentVersion",
