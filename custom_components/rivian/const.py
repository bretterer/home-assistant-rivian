...
SENSORS: Final[dict[str, tuple[RivianSensorEntityDescription, ...]]] = {
    "R1": (
        ...
        RivianSensorEntityDescription(
            ...
            name="Front Fascia Bluetooth Module Failure Status",
            icon="mdi:bluetooth",
            entity_category=EntityCategory.DIAGNOSTIC,
        ),
        RivianSensorEntityDescription(
            ...
            name="Rear Fascia Bluetooth Module Failure Status",
            icon="mdi:bluetooth",
            entity_category=EntityCategory.DIAGNOSTIC,
        ),
        RivianSensorEntityDescription(
            ...
            name="Instrument Controls Bluetooth Module Failure Status",
            icon="mdi:bluetooth",
            entity_category=EntityCategory.DIAGNOSTIC,
        ),
        RivianSensorEntityDescription(
            ...
            name="Right Front Door Bluetooth Module Failure Status",
            icon="mdi:bluetooth",
            entity_category=EntityCategory.DIAGNOSTIC,
        ),
        RivianSensorEntityDescription(
            ...
            name="Left Front Door Bluetooth Module Failure Status",
            icon="mdi:bluetooth",
            entity_category=EntityCategory.DIAGNOSTIC,
        ),
    ),
